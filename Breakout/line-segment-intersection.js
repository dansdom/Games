...
function updateBoard(){
    ...
    console.log('x1: ' + points[0].x + ', y1: ' + points[0].y + ', x2: ' + points[1].x + ', y2: ' + points[1].y);
    console.log('x3: ' + points[2].x + ', y3: ' + points[2].y + ', x4: ' + points[3].x + ', y4: ' + points[3].y);

    console.log(points[0].x + ', ' + points[0].y + ', ' + points[1].x + ', ' + points[1].y + ', ' + points[2].x + ', ' + points[2].y + ',  ' + points[3].x + ', ' + points[3].y);
